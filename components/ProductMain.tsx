...
const MINI_REVIEWS = [
  { name: "María G.", text: "Nadie me preguntó si me teñí. Solo que me veía bien." },
  { name: "Roberto L.", text: "Lo uso en casa, nadie lo sabe. Funciona." },
  { name: "Javier M.", text: "Tuve paciencia y a la segunda semana se notó." },
  { name: "Carmen A.", text: "Por fin algo que no me irrita el cuero cabelludo." },
  { name: "Patricia V.", text: "El cambio es gradual. Nadie pregunta nada." },
  { name: "Andrés P.", text: "Tengo 41 años. No me veía usando tinte. Esto es diferente." },
  { name: "Sofía R.", text: "Cabello suave y con brillo. Mejor que con tintes." },
  { name: "Lucía B.", text: "Mi hija me lo regaló. Ahora yo se lo recomiendo a todas." },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-16 items-start">
          ...
          <div className="order-1 lg:hidden">
            <div className="flex flex-wrap items-center gap-2 mb-2">
              <span className="text-xs bg-green-50 text-green-700 font-semibold px-2.5 py-0.5 rounded-full">100% Natural</span>
              <span className="text-xs bg-brown-50 text-brown-600 font-semibold px-2.5 py-0.5 rounded-full">Garantía 30 días</span>
            </div>
            ...
            <p className="text-xs font-semibold tracking-widest uppercase text-brown-400 mb-3">
              Cubre tus canas en la ducha. Sin químicos.
            </p>
          </div>
          ...
          <div className="order-3 lg:order-2">
            ...
            <div className="hidden lg:flex flex-wrap items-center gap-2 mb-3">
              <span className="text-xs bg-green-50 text-green-700 font-semibold px-2.5 py-0.5 rounded-full">100% Natural</span>
              <span className="text-xs bg-brown-50 text-brown-600 font-semibold px-2.5 py-0.5 rounded-full">Garantía 30 días</span>
              <span className="text-xs bg-cream-100 text-brown-500 font-semibold px-2.5 py-0.5 rounded-full">No mancha la piel</span>
            </div>
